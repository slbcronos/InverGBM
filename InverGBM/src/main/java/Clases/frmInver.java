 ...
 * @author slb_1
 */
public class frmInver extends javax.swing.JFrame {

    /**
     * Creates new form frmInver
     */
    public frmInver() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmInver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
